...
RSpec.describe User, type: :model do
  describe 'ユーザー新規登録' do
    let(:user) { User.new(nickname: 'aaa', email: 'test@example', password: 'aaa000', password_confirmation: 'aaa000', family_name: '山田', name: '太郎', kana_family_name: 'ヤマダ', kana_name: 'タロウ', birthday: '2000-01-01') }
    ...
    it '重複したemailが存在する場合は登録できない' do
      user.save
      another_user = User.new(nickname: 'bbb', email: user.email, password: 'bbb111', password_confirmation: 'bbb111', family_name: '佐藤', name: '次郎', kana_family_name: 'サトウ', kana_name: 'ジロウ', birthday: '1990-01-01')
      another_user.valid?
