...
ActiveRecord::Schema[7.0].define(version: 2024_11_13_064848) do
  ...
  create_table "days_up_to_deliveries", charset: "utf8", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "product_statuses", charset: "utf8", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
